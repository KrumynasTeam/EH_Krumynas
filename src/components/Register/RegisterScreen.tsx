...
export const FormLine = ({ type, setInputValue, inputValue, placeholder, regex, onInvalidMessage, isRequired }) => (
    <input
        pattern={regex}
        type={type}
        value={inputValue}
        ...
        <div className="center-text">
            <div id="registerform">
                ...
                <form onSubmit={sendRequest}>
                    <div className="row">
                        <label>Email</label>
                        <FormLine type="text" inputValue={email} setInputValue={setEmail} placeholder='Enter your email' regex="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" onInvalidMessage="Invalid email address." isRequired={true} />
                    </div>
                    <div className="row">
                        <label>Username</label>
                        <FormLine type="text" inputValue={username} setInputValue={setUsername} placeholder='Enter your username' regex="^[a-zA-Z0-9]{6,12}$" onInvalidMessage="Must be between 6-12 characters of letter and numbers." isRequired={true} />
                    </div>
                    <div className="row">
                        ...
                        <FormLine type="password" inputValue={password} setInputValue={setPassword} placeholder='Enter your password' regex="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,16}$"
                            onInvalidMessage="Password must be between 8-16 characters long and contain one upper letter, lower letter and number." isRequired={true} />
                    </div>
